...
\begin{document}
    ...
    \begin{multicols*}{4}
        ...
        \input{content/07_gui_threading.tex}
        \input{content/08_memory_models.tex}
        \input{content/09_actor_model.tex}
        \input{content/10_gpu.tex}
        \input{content/11_gpu_2.tex}
        \input{content/12_cluster.tex}
        \input{content/13_python_js.tex}
